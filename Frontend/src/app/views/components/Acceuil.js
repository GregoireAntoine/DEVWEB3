      ...
      <div className="acceuil">
        <div className="description">
          <p>
            ...
            Etant donné les conditions sanitaires actuelle et au vu du succès de nos produits,<br></br> nous avons décidé de vous proposer une formule de réservation en ligne de vos produits
            dans le but de désangorger la boutique.
          </p>
        </div>

        <div className="expliquation">
          <p>
            <h3>Explication</h3>
        ...
        <Link class="startButton" to="/home" >J'ai compris</Link>
      </div>
    )
}
